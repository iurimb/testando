...
#print(matriz)
    ...
    def movimento_rainha_preto(self, nova_posicao, matriz):
        ...
        if(q_torre == True):
            ...
            Tabuleiro.movimento_torre_preto(self, nova_posicao, tabuleiro)
            print("claro q volto pra cá, certo? {}".format(tabuleiro[1][3]))
            return tabuleiro
        
        else: 
            q_bispo = False
            Tabuleiro.movimento_bispo_preto(self, nova_posicao, tabuleiro)
    ...
    def movimento_rainha_branco(self, nova_posicao, matriz):
        ...
        if(q_torre == True):
            q_torre = False
            Tabuleiro.movimento_torre_branco(self, nova_posicao, tabuleiro)
        else: 
            q_bispo = False
            Tabuleiro.movimento_bispo_branco(self, nova_posicao, tabuleiro)
